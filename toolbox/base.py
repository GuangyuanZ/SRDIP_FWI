...
class optimize(object):
    ...
    def __init__(self, misfit_type, scheme, maxiter, step_length,step_length1,step_length2,decay_step1,decay_step2,vpmax, vpmin, marine_or_land,
        ...
        self.step_length1 = step_length1
        self.step_length2 = step_length2
        self.decay_step1 = decay_step1
        self.decay_step2 = decay_step2
        self.vpmax = vpmax
        self.vpmin = vpmin
    ...
    def __check(self):
        ...
        if self.scheme not in ['NLCG', 'LBFGS','ADAM']:
