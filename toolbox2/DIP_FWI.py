...
def DIP_inversion_unet_dn(simu, optim,layer_num,inv_model,load_pretrained = True):
    ...
    optimizer2 = torch.optim.Adam([DIP_model.random_latent_vector], lr=0.001*1000*2)#uccess
    ...
    scheduler2 = torch.optim.lr_scheduler.StepLR(optimizer2,step_size=400,gamma=0.8)
