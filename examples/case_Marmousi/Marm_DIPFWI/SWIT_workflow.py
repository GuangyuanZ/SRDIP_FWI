...
from DIP_FWI import DIP_inversion_unet
modelpath = '/xxx/Marm_DIPFWI/model/' 
homepath  = '/xxx/Marm_DIPFWI/'  # working path
...
vp_init = loadbinfloat32('/xxx/Marm_DIPFWI/model/vp-50.bin').reshape(nx,nz)
...
### begin inversion
DIP_inversion_unet(simu, optim,4,{'vp':vp_init,'rho':rho_init},load_pretrained = False)
